...
class RubberBottomSheetTextRecognitionWidget extends StatefulWidget {
  ...
  RubberBottomSheetTextRecognitionWidget({this.listOfRecognizedText,this.initialvalue});


  @override
  _RubberBottomSheetTextRecognitionWidgetState createState() => _RubberBottomSheetTextRecognitionWidgetState();
}

class _RubberBottomSheetTextRecognitionWidgetState extends State<RubberBottomSheetTextRecognitionWidget> with SingleTickerProviderStateMixin {
...
// Here you can write your code
  ...
  Widget build(BuildContext context) {
    return ModifiedRubberBottomSheet(
                ...
                Expanded(
                  ...
                  child: Container(
                      ...
                      child:  Padding(
                        ...
                        child: Text('Detected Text',style: TextStyle(fontSize: 18),),
                      ),
            ...
            upperLayer:SelectableText(widget.listOfRecognizedText[0]),// InfoView(),//_getBodyLayer(),

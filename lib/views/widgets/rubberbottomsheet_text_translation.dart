...
import 'package:google_lens_clone/views/pages/reverse_translation_view.dart';
import 'package:rubber/rubber.dart';

class RubberBottomSheetTextTranslationWidget extends StatefulWidget {
  ...
  @override
  _RubberBottomSheetTextTranslationWidgetState createState() =>
      _RubberBottomSheetTextTranslationWidgetState();
}

class _RubberBottomSheetTextTranslationWidgetState
    extends State<RubberBottomSheetTextTranslationWidget>
...
//              color: Colors.amber,
      ...
      upperLayer: ReverseTranslationView(
        _scrollController,
        widget.sentence,
